...
namespace BusinessObject.Services
{
    ...
    {
        private readonly List<MemberObject> _members;
        private readonly IPasswordHasher _passwordHasher;
        public MemberObject? CurrentMember { get; set; }
        public AuthenticationService(IOptions<List<MemberObject>> memberList, IPasswordHasher passwordHasher)
        {
        ...
        public MemberObject CurrentUser() => CurrentMember;
